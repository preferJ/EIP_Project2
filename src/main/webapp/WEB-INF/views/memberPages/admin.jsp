...
<body>
<h1>admin</h1>
<%--<button onclick="qwe()">qwe버튼</button>--%>
<%--<div id="qweqwe">asdsadsad</div>--%>
<div class="memberL">
    회원
    <table class="table">
        <tr>
        ...
        <c:forEach items="${memberDTOList}" var="memberDTOList">
            <tr >
                ...
                <td><a href="/member/delete?id=${memberDTOList.id}">삭제</a></td>
...
<%--            <tr onclick="asd(asd${commentDTOList.id})" id="asd${commentDTOList.id}">--%>
